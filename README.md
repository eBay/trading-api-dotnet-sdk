...
``` xml
Install-Package eBay.Service.SDK -Version 1.0.2
```
...
``` xml
<ItemGroup>
   <PackageReference Include="eBay.Service.SDK" Version="1.0.2" />
</ItemGroup>
```
...
``` xml
dotnet add package eBay.Service.SDK --version 1.0.2
```
...
``` xml
paket add eBay.Service.SDK --version 1.0.2
```
