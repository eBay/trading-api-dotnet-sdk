...
``` xml
Install-Package eBay.Service.SDK -Version 1.0.3
```
...
``` xml
<ItemGroup>
   <PackageReference Include="eBay.Service.SDK" Version="1.0.3" />
</ItemGroup>
```
...
``` xml
dotnet add package eBay.Service.SDK --version 1.0.3
```
...
``` xml
paket add eBay.Service.SDK --version 1.0.3
```
